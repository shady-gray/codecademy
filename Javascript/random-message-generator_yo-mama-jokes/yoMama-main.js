...
"a is so mean, even Hello Kitty said goodbye.","house is so dirty, she has to wipe her feet before she goes outside.","so old, she was a waitress at the Last Supper.",
...
let randJoke = yoMamaJokes[Math.floor(Math.random() * yoMamaJokes.length)];
const displayAJoke = () => {console.log(`Yo Mama's ${randJoke}`)}
